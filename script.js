...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function fetchTasks() {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1219").then(checkStatus).then(json).then(function (response) {
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "?api_key=1219", {
        method: "DELETE",
        mode: "cors"
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "/mark_" + newState + "?api_key=1219", {
        method: "PUT",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
        _this5.fetchTasks();
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=1219", {
        method: "POST",
        mode: "cors",
